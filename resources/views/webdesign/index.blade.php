...
<head>
  ...
  <link rel="icon" href="{{public_path('webdesign/images/favicon.jpg')}}" type="image/x-icon">

  <link rel="stylesheet" href="{{public_path('webdesign/css/grid.css')}}">

  <link rel="stylesheet" href="{{public_path('webdesign/css/style.css')}}">

  <script src="{{public_path('webdesign/js/jquery.js')}}"></script>

  <script src="{{public_path('webdesign/js/jquery-migrate-1.2.1.js')}}"></script>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="grid_12">
            ...
            <div class="logo"><img src="{{public_path('webdesign/images/logo.jpg')}}" alt="" width="120" height="120"></div>
          ...
          <div class="row">
            ...
            <div class="grid_12">
              ...
              <div class="blockquote-img wow fadeInDown">
                ...
                <img src="{{public_path('webdesign/images/blockquote-img.png')}}" alt="">
              ...
              <div id="owl" class="owl-carousel wow fadeInLeft">                
                ...
                <div class="blockquote item grid_6">
                  ...
                  <img src="{{public_path('webdesign/images/test-3.jpg')}}" width="200" height="200" alt="" class="testimonial-img tits">
                ...
                <div class="blockquote item grid_6">
                  ...
                  <img src="{{public_path('webdesign/images/test-4.jpg')}}" alt="" width="200" height="200" class="testimonial-img tits">
                ...
                <div class="blockquote item grid_6">
                  ...
                  <img src="{{public_path('webdesign/images/safebets.png')}}" alt="" width="200" height="200"  class="testimonial-img tits">
                ...
                <div class="blockquote item grid_6">
                  ...
                  <img src="{{public_path('webdesign/images/test-2.jpg')}}" width="200" height="200" -alt="" class="testimonial-img tits">
            ...
            <div class="grid_12">
              ...
              <div class="folio-block">
                ...
                <div class="folio-thumb filter-video anim">
                  ...
                  <img src="{{public_path('webdesign/images/portfolio-1.jpg')}}" alt="" >
                  ...
                  <div class="folio-description">
                    ...
                    <p><a href="{{public_path('webdesign/images/portfolio-1.jpg')}}" class="fa fa-search-plus zoom"></a></p>
                ...
                <div class="folio-thumb filter-photo anim">
                  ...
                  <img src="{{public_path('webdesign/images/portfolio-2.jpg')}}" alt="" >
                  ...
                  <div class="folio-description">
                    ...
                    <p><a href="{{public_path('webdesign/images/portfolio-2.jpg')}}" class="fa fa-search-plus zoom"></a></p>
                ...
                <div class="folio-thumb filter-logo anim">
                  ...
                  <img src="{{public_path('webdesign/images/portfolio-3.jpg')}}" alt="" >
                  ...
                  <div class="folio-description">
                    ...
                    <p><a href="{{public_path('webdesign/images/portfolio-3.jpg')}}" class="fa fa-search-plus zoom"></a></p>
                ...
                <div class="folio-thumb filter-branding anim">
                  ...
                  <img src="{{public_path('webdesign/images/portfolio-4.jpg')}}" alt="" >
                  ...
                  <div class="folio-description">
                    ...
                    <p><a href="{{public_path('webdesign/images/portfolio-4.jpg')}}" class="fa fa-search-plus zoom"></a></p>
                ...
                <div class="folio-thumb filter-logo anim">
                  ...
                  <img src="{{public_path('webdesign/images/portfolio-5.jpg')}}" alt="" >
                  ...
                  <div class="folio-description">
                    ...
                    <p><a href="{{public_path('webdesign/images/portfolio-5.jpg')}}" class="fa fa-search-plus zoom"></a></p>
                ...
                <div class="folio-thumb filter-photo anim">
                  ...
                  <img src="{{public_path('webdesign/images/portfolio-6.jpg')}}" alt="" >
                  ...
                  <div class="folio-description">
                    ...
                    <p><a href="{{public_path('webdesign/images/portfolio-6.jpg')}}" class="fa fa-search-plus zoom"></a></p>
                ...
                <div class="folio-thumb filter-branding anim">
                  ...
                  <img src="{{public_path('webdesign/images/portfolio-7.jpg')}}" alt="" >
                  ...
                  <div class="folio-description">
                    ...
                    <p><a href="{{public_path('webdesign/images/portfolio-7.jpg')}}" class="fa fa-search-plus zoom"></a></p>
                ...
                <div class="folio-thumb filter-video anim">
                  ...
                  <img src="{{public_path('webdesign/images/portfolio-8.jpg')}}" alt="" >
                  ...
                  <div class="folio-description">
                    ...
                    <p><a href="{{public_path('webdesign/images/portfolio-8.jpg')}}" class="fa fa-search-plus zoom"></a></p>
                ...
                <div class="folio-thumb filter-photo anim">
                  ...
                  <img src="{{public_path('webdesign/images/portfolio-9.jpg')}}" alt="" >
                  ...
                  <div class="folio-description">
                    ...
                    <p><a href="{{public_path('webdesign/images/portfolio-9.jpg')}}" class="fa fa-search-plus zoom"></a></p>
...
<script src="{{public_path('webdesign/js/script.js')}}"></script>
